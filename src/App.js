        ...
        <Types>
          ...
          <ul>
            <li>
              ...
              <article>Os itens a serem descartados geralmente são acondicionados em sacos brancos com o símbolo de risco padrão para materiais infectantes, podendo ou não ser esterilizados o que faria com que passassem por um micro-ondas ou pela incineração.
            ...
            <li>
              ...
              <article>Antes de serem descartados, os resíduos químicos precisam passar por um tratamento especializado, além de ser coletado periodicamente. Os que não podem ser recuperados, devem ser guardados em reservatórios próprios para o descarte.
            ...
            <li>
              ...
              <article>A primeira etapa no gerenciamento é a armazenagem não definitiva dos resíduos no próprio local de geração, enquanto aguardam a disposição final. Sendo de responsabilidade do gerador a armazenagem correta.
            ...
            <li>
              ...
              <article>Os resíduos comuns (aqueles que não estão contaminados e não oferecem grandes riscos) podem ser reciclados, na maioria das vezes. Assim, eles precisam ser levados a centros de reciclagem ou a postos de coleta seletiva. 
            ...
            <li>
              ...
              <article>Os materiais perfurocortantes devem ser descartados separadamente, no local de sua geração, imediatamente após o uso ou necessidade de descarte, em recipientes de paredes rígidas, resistentes à punctura, ruptura e vazamento, resistentes ao processo de esterilização, com tampa, devidamente identificados com o símbolo internacional de risco biológico
